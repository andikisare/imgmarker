...
These output files are easily aggregated and analyzed using standard coding or spreadsheet tools. Local analysis enables trained observers to quickly scan through images with loading times not limited by internet connections and thus enables faster identifications or classifications.
