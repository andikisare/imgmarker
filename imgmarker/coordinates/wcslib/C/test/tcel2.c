/*============================================================================
  ...
  $Id: tcel2.c,v 8.4 2024/10/28 13:56:17 mcalabre Exp $
*=============================================================================
*
...

{
  ...
  for (iprj = 0; iprj < 4; iprj++) {
    ...
    strcpy(celestial.prj.code, native.prj.code);
    celestial.prj.pv[1] = native.prj.pv[1];
    celestial.prj.pv[2] = native.prj.pv[2];
