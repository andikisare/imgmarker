/*============================================================================
  ...
  $Id: ttab1.c,v 8.4 2024/10/28 13:56:17 mcalabre Exp $
*=============================================================================
*
...
{
  // These variables are used by several independent tests.
  int    K[2], M, nFail = 0, stat0[128], stat1[128], status, status0, status1;
  double *index[1], resid, residmax, s[16], world[11][11][2],
         xt0[16], xt1[16], x0[11][11][2], x1[11][11][2];
  ...
  double z = 1.0 / (double)((K1-1) * (K2-1));
  for (int k2 = 0, n = 0; k2 < K2; k2++) {
  ...
  for (int i = 0; i < 11; i++) {
    for (int j = 0; j < 11; j++) {
      ...
      double psi_0 = i*(K1-1)/10.0;
      double psi_1 = j*(K2-1)/10.0;
